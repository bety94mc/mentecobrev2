# Generated by Django 4.0b1 on 2022-04-16 11:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rango', models.CharField(blank=True, choices=[('Ad', 'Admin'), ('Col', 'Colaborador')], max_length=3, null=True)),
                ('universo', multiselectfield.db.fields.MultiSelectField(blank=True, choices=[('A', 'Aliento de los diosos'), ('AB', 'Arena Blanca'), ('AE', 'El alma del emperador'), ('AL', 'Alcatraz'), ('C', 'Cosmere'), ('CT', 'Citoverso'), ('E', 'Elantris'), ('FU', 'Fuera del universo'), ('L', 'Legión'), ('M', 'Nacidos de la bruma'), ('OH', 'Otras Historias'), ('R', 'Rithmatista'), ('RK', 'Reckoners'), ('RT', 'Rueda del Tiempo'), ('S', 'Archivo de las tormentas'), ('SO', 'Sexto del Ocaso'), ('SS', 'Sombras por silencio')], max_length=20, null=True)),
